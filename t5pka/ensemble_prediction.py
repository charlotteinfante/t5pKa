...
def predict(args):
    ...
    print('RMSE:', rmse(df['targets'], df['average']))
    print('MAE:', mean_absolute_error(df['targets'], df['average']))
    print('r2:', r2_score(df['targets'], df['average']))
    print('r:', r_value)
    print('RMSE random split:', rmse(df['targets'], df['random split average']))
    print('RMSE scaffold split:', rmse(df['targets'], df['scaffold split average']))
