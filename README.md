...
## Models
We leverage the multitasking ability of T5Chem, and we added the prefixes "acidic" and "basic" to train <u>one</u> macroscopic pKa model. Depending on the type of pKa the user would like to predict, they can use the different prefixes to 
