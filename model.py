...
class T5ForProperty(T5ForConditionalGeneration):
    ...
    def __init__(
        ...
        if not self.head_type:
            ...
            lm_head_layers.extend([nn.Linear(config.d_model, num_classes)])
            ...
            lm_head_layers.extend([nn.Linear(config.d_model, 2 * num_classes)])
        ...
        #self.set_output_embeddings(lm_head_layers)
