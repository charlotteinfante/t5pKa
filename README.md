...
Inspired by the work of Jieyu Lu et al. (2022) {https://pubs.acs.org/doi/full/10.1021/acs.jcim.1c01467}, we use T5Chem--a T5 model built on HuggingFace Transformers--to predict macroscopic <p><i>p</i><sub><i>K</i>a</sub></p>, mircoscopic pKa, and protonation sites of small molecules. 

## Models
We leverage the multitasking ability of T5Chem, and we added the prefixes "acidic" and "basic" to train __one__ macroscopic pKa model. Depending on the type of pKa the user would like to predict, they can attach the prefix to the SMILES of the molecule of interest to predict either its acidic or basic macroscopic pKa. 
